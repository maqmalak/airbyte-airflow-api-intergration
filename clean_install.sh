...
if [ "$EUID" -eq 0 ]; then
    ...
    echo "NOTE: Not running as root. Skipping Docker service management."
...
chmod -R 777 dags/ logs/ plugins/ temporal/ sparkFiles/ outputs/
...
echo "  Airbyte: (check Airbyte documentation for defaults)"
echo ""
echo "Next steps:"
